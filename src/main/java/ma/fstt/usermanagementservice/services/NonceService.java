...
public class NonceService {
    ...
    public void storeNonce(String wallet, String nonce) {
        User user = userRepository.findByWallet(wallet)
                .orElseThrow(() -> new UserNotFoundException("User does not existe with this wallet : "+wallet));
    ...
    /**
     * Récupère un nonce existant pour un wallet
     */
    ...
    /**
     * Supprime un nonce pour un wallet donné
     */
    @Transactional
